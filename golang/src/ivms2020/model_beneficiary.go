...
func NewBeneficiary(beneficiaryPersons []Person, accountNumber []string) *Beneficiary {
	this := Beneficiary{}
...
// GetBeneficiaryPersons returns the BeneficiaryPersons field value
...
// GetBeneficiaryPersonsOk returns a tuple with the BeneficiaryPersons field value
...
// and a boolean to check if the value has been set.
func (o *Beneficiary) GetAccountNumberOk() ([]string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Beneficiary) SetAccountNumber(v []string) {
	o.AccountNumber = v
}
...
func (o Beneficiary) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["beneficiaryPersons"] = o.BeneficiaryPersons
