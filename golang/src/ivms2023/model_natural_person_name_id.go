...
type NaturalPersonNameId struct {
	...
	NaturalPersonNameIdentifierType *string `json:"naturalPersonNameIdentifierType,omitempty"`
}
...
// GetNaturalPersonNameIdentifierType returns the NaturalPersonNameIdentifierType field value if set, zero value otherwise.
func (o *NaturalPersonNameId) GetNaturalPersonNameIdentifierType() string {
	if o == nil || IsNil(o.NaturalPersonNameIdentifierType) {
		var ret string
		return ret
	}
	return *o.NaturalPersonNameIdentifierType
}

// GetNaturalPersonNameIdentifierTypeOk returns a tuple with the NaturalPersonNameIdentifierType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *NaturalPersonNameId) GetNaturalPersonNameIdentifierTypeOk() (*string, bool) {
	if o == nil || IsNil(o.NaturalPersonNameIdentifierType) {
		return nil, false
	}
	return o.NaturalPersonNameIdentifierType, true
}

// HasNaturalPersonNameIdentifierType returns a boolean if a field has been set.
func (o *NaturalPersonNameId) HasNaturalPersonNameIdentifierType() bool {
	if o != nil && !IsNil(o.NaturalPersonNameIdentifierType) {
		return true
	}
...
// SetNaturalPersonNameIdentifierType gets a reference to the given string and assigns it to the NaturalPersonNameIdentifierType field.
func (o *NaturalPersonNameId) SetNaturalPersonNameIdentifierType(v string) {
	o.NaturalPersonNameIdentifierType = &v
}
...
func (o NaturalPersonNameId) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.NaturalPersonNameIdentifierType) {
		toSerialize["naturalPersonNameIdentifierType"] = o.NaturalPersonNameIdentifierType
	}
